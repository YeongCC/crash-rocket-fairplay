...
const GameInfo: React.FC = () => {
  return (
    <div className="flex items-center justify-between w-full max-w-5xl mx-auto px-4 py-2">
      <h1 className="text-2xl font-bold">Fuyo Crash</h1>
        ...
        <Popover>
          ...
          <PopoverContent className="w-80 p-4">
            <div className="space-y-2">
              ...
              <p className="text-sm">
              Fuyo Crash is a multiplayer game where you bet on the multiplier before the plane flies away.
              </p>
        ...
        <Popover>
          ...
          <PopoverContent className="w-80 p-4">
            <div className="space-y-2">
              ...
              <p className="text-sm">
              Fuyo Crash uses a provably fair system to ensure that game results cannot be manipulated.
              </p>
              <p className="text-sm mt-2">
